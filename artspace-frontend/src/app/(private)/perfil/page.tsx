  ...
  if (!perfil) {
    return (
      <div className="max-w-5xl mx-auto py-20 text-center text-gray-500">
        ...
        <p className="text-xl font-semibold">No se pudo cargar tu perfil</p>
      </div>
    );
  }
    ...
    <div className="max-w-5xl mx-auto py-8 px-4 space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border p-6 md:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <p className="text-gray-500 mt-1 text-sm leading-relaxed max-w-md">
            {perfil.biografia || (
              <span className="italic">
                Aún no tienes una biografía.{' '}
                <Link href="/perfil/editar" className="text-black underline hover:no-underline">
                  Agrégala aquí
                </Link>
              </span>
            )}
        ...
        <div className="flex flex-col gap-2 shrink-0">
          <Link
            href="/perfil/editar"
            className="px-6 py-2.5 rounded-xl font-semibold text-sm border border-gray-200 text-gray-700 hover:bg-gray-50 transition text-center"
          >
            Editar perfil
          </Link>
          <Link
            href="/obras/nueva"
            className="px-6 py-2.5 rounded-xl font-semibold text-sm bg-black text-white hover:bg-gray-800 transition text-center"
          >
            + Nueva obra
          </Link>
        </div>
